                    ...
                    <tr id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
                        <td class="img">
                            ...
                            if ( $grouped_product->is_visible() ) {
                                echo '<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink( $grouped_product->get_id() ), $grouped_product->get_id() ) ) . '">' .  get_the_post_thumbnail( $grouped_product->get_id(), 'thumbnail') . '</a>';
                            } else {
                        ...
                        <td class="label">
                            ...
                            <div class="price">
                                <?php
                                    echo ent2ncr($grouped_product->get_price_html());
