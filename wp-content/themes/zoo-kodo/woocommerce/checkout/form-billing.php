...
<div class="woocommerce-billing-fields">
    <?php if (wc_ship_to_billing_address_only() && WC()->cart->needs_shipping()) : ?>
        ...
        <h3 class="title-block-page"><span><?php esc_html_e( 'Billing &amp; Shipping', 'woocommerce' ); ?></span></h3>

    <?php else : ?>

        <h3 class="title-block-page"><span><?php esc_html_e('Billing details', 'woocommerce'); ?></span></h3>
