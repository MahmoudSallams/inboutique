            ...
            foreach ($attributes as $attribute_name => $options) :
                ...
                <li class="<?php echo esc_attr($zoo_cw_tr_class) ?>">
                    ...
                    <div class="value zoo-cw-group-attribute <?php echo esc_attr($zoo_cw_attr_class); ?>"
                        ...
                        if ($product_swatch_data_array != '') {
                            if ($zoo_cw_attribute['display_type'] != 'default'): ?>
                                ...
                                <?php foreach ($zoo_cw_attribute_options as $zoo_cw_attribute_option):
                                    ...
                                    ?>
                                    <div class="zoo-cw-attribute-option <?php echo esc_attr($zoo_cw_attribute_option['option_class']); if ($selected == $zoo_cw_attr_val) echo esc_attr(' zoo-cw-active '); ?>"
                                         data-attribute-option="<?php echo esc_attr($zoo_cw_attr_val); ?>" data-attribute-name=" <?php echo esc_attr($zoo_cw_attr_name); ?>">
                                        ...
                                        <?php if ($zoo_cw_attribute['product_swatch_display_name_yn'] == 1 &&$zoo_cw_attribute['display_type'] == 'text'): ?>
                            ...
                            <?php else: ?>
                                <select class="zoo-cw-attribute-select" name="">
                                    ...
                                    <?php foreach ($zoo_cw_attribute_options as $zoo_cw_attribute_option):
                                        ...
                                        $zoo_cw_attr_val = isset($zoo_cw_attribute_option['value']) ? $zoo_cw_attribute_option['value'] : '';
                                        ?>
                                        <option value="<?php echo esc_attr($zoo_cw_attr_val); ?>" class="attached enabled"><?php echo esc_attr($zoo_cw_attr_name); ?></option>
                        ...
                        ?>
                        <input name="<?php echo(esc_attr("attribute_" . $attribute_slug)); ?>" value="<?php echo $selected?>" type="hidden">
                    </div>
                </li>
            <?php endforeach; ?>
        </ul>
