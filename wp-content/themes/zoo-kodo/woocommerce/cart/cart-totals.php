...
<div class="cart_totals <?php if (WC()->customer->has_calculated_shipping()) echo 'calculated_shipping'; ?>">
    ...
    <h3 class="title-block-page"><span><?php esc_html_e('Cart totals', 'woocommerce'); ?></span></h3>
    <div class="wrap-cart-coupon">
        <?php if (wc_coupons_enabled()) { ?>
            <p class="heading-coupon"><span><?php esc_html_e('Enter Coupon', 'zoo-kodo'); ?></span></p>
    ...
    <ul class="shop_table shop_table_responsive zoo-table-total-cart">
        ...
        <li class="order-total">
            <div class="label-row"><?php esc_html_e('Total', 'woocommerce'); ?></div>
