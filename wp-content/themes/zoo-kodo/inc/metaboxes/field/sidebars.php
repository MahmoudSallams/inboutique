    ...
    class RWMB_Sidebars_field extends RWMB_Field {
        ...
        */
        static function html( $meta, $field ) {
            ...
            if ( !empty( $meta ) && !strcmp( $meta[0], 'inherit' ) ) {
                $html .= ' selected="selected"';
            }
            $html .= '>' . esc_html__('Inherit', 'zoo-kodo') . '</option>';

            $html .= '<option value="none"';
            if ( !empty( $meta ) && !strcmp( $meta[0], 'none' ) ) {
                $html .= ' selected="selected"';
            }
            $html .= '>' . esc_html__('None', 'zoo-kodo') . '</option>';
        ...
        */
        static function normalize_field( $field ) {
            ...
            if ( !$field['clone'] && $field['multiple'] ) $field['field_name'] .= '[]';
