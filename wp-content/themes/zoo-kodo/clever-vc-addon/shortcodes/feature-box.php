...
/* Start $media_style */
$media_style = 'display: inline-block;';
...
?>
<div class="zoo-feature-box<?php echo esc_attr($css_class); ?>" style="<?php echo esc_attr( $box_style ); ?>">
    ...
    if ($atts['type'] != '') {
        switch ($atts['style']) {
            ...
            case 'after': ?>
                ...
                <div class="feature-box-media" style="<?php echo esc_attr( $media_style ); ?>">
                    <?php if ($atts['type'] == 'icon') : ?>
                        <i class="circus-box <?php echo esc_attr($icon) ?>" style="font-size: <?php echo esc_attr( $atts['icon_fontsize'] ); ?>"></i>
                    <?php endif; ?>
            ...
            case 'right': ?>
                <div class="media">
                    ...
                    <div class="pull-left">
                        <span class="feature-box-media" style="<?php echo esc_attr( $media_style ); ?>">
                            <?php if ($atts['type'] == 'icon') : ?>
                                <i class="circus-box <?php echo esc_attr($icon) ?>" style="font-size: <?php echo esc_attr( $atts['icon_fontsize'] ); ?>"></i>
                            <?php endif; ?>
