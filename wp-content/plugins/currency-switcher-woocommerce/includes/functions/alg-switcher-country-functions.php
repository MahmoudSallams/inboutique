<?php
/**
 * Currency Switcher Country Functions
 *
 * @version 2.6.0
 * @since   2.0.0
 * @author  Tom Anbinder
...
if ( ! function_exists( 'alg_get_country_flag_image_url' ) ) {
	/**
	 * alg_get_country_flag_image_url.
	 *
	 * @version 2.6.0
	 * @since   2.4.4
	 * @todo    ensure all flag images exist (instead of checking for `getimagesize()`)
	 */
	function alg_get_country_flag_image_url( $country_code ) {
		$file_url = alg_wc_currency_switcher_plugin()->plugin_url() . '/assets/images/flag-icons/' . strtolower( $country_code ) . '.png';
		return ( @getimagesize( $file_url ) ? $file_url : alg_wc_currency_switcher_plugin()->plugin_url() . '/assets/images/flag-icons/' . 'global' . '.png' );
	}
}

if ( ! function_exists( 'alg_get_currency_countries' ) ) {
	/**
	 * alg_get_currency_countries.
	 *
	 ...
	 * @return  array
	 */
	function alg_get_currency_countries() {
		return array(
			'AFN' => array( 'AF' ),
			'ALL' => array( 'AL' ),
			'DZD' => array( 'DZ' ),
			'USD' => array( 'US', 'AS', 'IO', 'GU', 'MH', 'FM', 'MP', 'PW', 'PR', 'TC', 'UM', 'VI' ),
			'EUR' => array( 'EU', 'AD', 'AT', 'BE', 'CY', 'EE', 'FI', 'FR', 'GF', 'TF', 'DE', 'GR', 'GP', 'IE', 'IT', 'LV', 'LT', 'LU', 'MT', 'MQ', 'YT', 'MC', 'ME', 'NL', 'PT', 'RE', 'PM', 'SM', 'SK', 'SI', 'ES' ),
			'AOA' => array( 'AO' ),
...
if ( ! function_exists( 'alg_get_countries' ) ) {
	/**
	 * alg_get_countries.
	 *
	 * @version 2.0.0
