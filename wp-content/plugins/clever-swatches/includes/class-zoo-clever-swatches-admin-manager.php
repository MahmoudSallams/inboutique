...
if( !class_exists( 'Zoo_Clever_Swatch_Admin_Manager' ) ){
    ...
    class Zoo_Clever_Swatch_Admin_Manager{
        ...
        function zoo_cw_add_settings_page(){
            ...
            add_menu_page('CleverSwatches', 'CleverSwatches', 'manage_woocommerce', 'zoo-cw-settings', array($this, 'zoo_cw_settings_callback'),ZOO_CW_GALLERYPATH.'cleverswatch.png',55.567 );
        }
